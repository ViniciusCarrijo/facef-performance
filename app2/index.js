...
const nginxUrl = process.env.APP2_NGINX_URL || 'http://localhost:80';
...
const redisHost = process.env.APP2_REDIS_HOST || 'localhost';
const redisPort = process.env.APP2_REDIS_PORT || 6379;
...
const logstashHost = process.env.APP2_LOGSTASH_HOST || 'localhost';
const logstashPort = process.env.APP2_LOGSTASH_PORT || 5000;
